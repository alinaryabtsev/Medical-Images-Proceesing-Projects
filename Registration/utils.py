...
def getPoints(outLiers):
    ...
    if (outLiers == 'no_outliers'):
        ...
        BLPointsOutLiers = np.array(
            [[863.75000, 68.500000], [1018.2500, 302.50000], [812.75000, 928], [970.25000, 491.50000],
             [298.25000, 686.50000], [1324.2500, 1223.5000]])
        BLPoints = np.append(BLPoints, BLPointsOutLiers, axis=0)
        FUPointsOutLiers = np.array(
            [[1105.2500, 95.500000], [1244.7500, 335.50000], [448.25000, 880], [475.25000, 472], [1367.7500, 773.50000],
             [275.75000, 1153]])
